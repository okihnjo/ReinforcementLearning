...
from RL2023HockeyTournamentClient_updated.client.remoteControllerInterface import RemoteControllerInterface
from RL2023HockeyTournamentClient_updated.client.backend.client import Client
...
class RemoteBasicOpponent(BasicOpponent, RemoteControllerInterface):
    ...
    my_agent = Agent(state_size=state_size, action_size=4, random_seed=0,hidden_size=256)
    load_model(my_agent.actor_local, "05.08.2023/21.48.57/sac_hockey.pt")
    ...
    def __init__(self, weak, keep_mode=True):
        ...
        RemoteControllerInterface.__init__(self, identifier='Okan')
...
if __name__ == '__main__':
    ...
    client = Client(username='LosNinos',
                    ...
                    num_games=None)
    client2 = Client(username='LosNinos',
                    password='chahT7nei8',
                    controller=controller,
                    output_path='logs/basic_opponents', # rollout buffer with finished games will be saved in here
                    interactive=False,
                    ...
                    # server_addr='localhost',
                    num_games=None)
    client3 = Client(username='LosNinos',
                    password='chahT7nei8',
                    controller=controller,
                    output_path='logs/basic_opponents', # rollout buffer with finished games will be saved in here
                    interactive=False,
                    ...
                    # server_addr='localhost',
                    num_games=None)
    client4 = Client(username='LosNinos',
                    password='chahT7nei8',
                    controller=controller,
                    output_path='logs/basic_opponents', # rollout buffer with finished games will be saved in here
                    interactive=False,
                    ...
                    # server_addr='localhost',
                    num_games=None)
    client5 = Client(username='LosNinos',
                    password='chahT7nei8',
                    controller=controller,
                    output_path='logs/basic_opponents', # rollout buffer with finished games will be saved in here
                    interactive=False,
